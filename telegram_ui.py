...
def _author_reply_keyboard(back_to_review: bool, people: list[tuple[str, str]]) -> dict:
...
def _match_author_option(text: str, people: list[tuple[str, str]]) -> tuple[str, str] | None:
